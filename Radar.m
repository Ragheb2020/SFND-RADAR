...
Rs   = 1;       % Range Resolution
Mr = 200;     % Max. Range
Vs  = 3;       % Velocity Resolution
Mv = 70;      % Max. Velocity
...
% Calculate the Bandwidth (Bandwidth), Chirp Time (sweeb_time) and Slope (slope) of the FMCW
% chirp using the requirements above.

Bandwidth      = c / 2*Rs;
sweeb_time = 5.5*Mr*2/c;
slope  = Bandwidth/sweeb_time;

fprintf("Bsweep = %f \t sweeb_time = %f \t slope = %f\n", Bandwidth, sweeb_time, slope)
...
t = linspace(0,Nd*sweeb_time,Nr*Nd); %total time for samples
L = length(t);
...
S = signal_fft(1:L/2+1);   % Taking only half of output
